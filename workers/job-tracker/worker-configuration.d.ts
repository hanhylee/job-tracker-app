/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c20894f0acb1a390fbe1a8e591837cbe)
...
declare namespace Cloudflare {
	...
	interface Env {
		RESUMES: R2Bucket;
		db: D1Database;
		BETTER_AUTH_SECRET: SecretsStoreSecret | string;
		GITHUB_CLIENT_ID: SecretsStoreSecret | string;
		GITHUB_CLIENT_SECRET: SecretsStoreSecret | string;
		RESEND_API_KEY: SecretsStoreSecret | string;
		SECRET: string;
		BETTER_AUTH_URL: string;
		SESSION_TOKEN: string;
		BASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SECRET" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "RESEND_API_KEY" | "SESSION_TOKEN" | "BASE_URL" | "FRONTEND_URL">> {}
}
